...
def selected_radio_button():
    ...
    if len(recepie_name.get()) == 0:
        ...
        if str(excel_entry(str(today.strftime("%d/%m/%Y")), str(recepie_name.get()), selections,
                           rates)) != "Excel Open":
...
recepie_name = Entry(root, width=25, font=("Roboto", 30), bg='light blue')
...
youtube_checkbox = Checkbutton(root, text=websites[0], variable=youtube_selected, onvalue=websites[0], font=("Roboto", 20), bg="white").place(relx=0.24, rely=0.36, anchor="w")
instagram_checkbox = Checkbutton(root, text=websites[1], variable=instagram_selected, onvalue=websites[1], font=("Roboto", 20), bg="white").place(relx=0.24, rely=0.42, anchor="w")
reel_checkbox = Checkbutton(root, text=websites[2], variable=reel_selected, onvalue=websites[2], font=("Roboto", 20), bg="white").place(relx=0.24, rely=0.48, anchor="w")
photo_checkbox = Checkbutton(root, text=websites[3], variable=photo_selected, onvalue=websites[3], font=("Roboto", 20), bg="white").place(relx=0.24, rely=0.54, anchor="w")
...
# youtube_amount = Entry(root, width=4, font=("Roboto", 25), bg='light blue').place(relx=0.463, rely=0.36, anchor=CENTER)
youtube_amount = Entry(root, textvariable=StringVar(root, value=rates[0]), width=4, font=("Roboto", 25), bg='light blue')
youtube_amount.place(relx=0.463, rely=0.36, anchor=CENTER)
instagram_amount = Entry(root, textvariable=StringVar(root, value=rates[1]), width=4, font=("Roboto", 25), bg='light blue')
instagram_amount.place(relx=0.463, rely=0.42, anchor=CENTER)
reel_amount = Entry(root, textvariable=StringVar(root, value=rates[2]), width=4, font=("Roboto", 25), bg='light blue')
reel_amount.place(relx=0.463, rely=0.48, anchor=CENTER)
photo_amount = Entry(root, textvariable=StringVar(root, value=rates[3]), width=4, font=("Roboto", 25), bg='light blue')
photo_amount.place(relx=0.463, rely=0.54, anchor=CENTER)

save = Button(root, text="S A V E", font=("Roboto", 20, 'bold'), justify='center', command=selected_radio_button)
save.configure(foreground="black")
save.configure(bg="light green")
save.place(relx=0.5, rely=0.77, anchor=CENTER)

status_label = Label(root, text="", font=("Roboto", 30), bg="white", fg="green")
status_label.place(relx=0.5, rely=0.9, anchor=CENTER)
